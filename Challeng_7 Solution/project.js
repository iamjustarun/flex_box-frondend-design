 ...
 */
function clearAll() {
    const bContent = document.querySelector('.content');
...
function showMeme() {
    ...
    imag.src = randomMemeUrl;
    var source = document.querySelector(".content");
    source.appendChild(bk);
...
function showJoke() {
    ...
    src = document.querySelector(".content");
    src.appendChild(newElement);
    // console.log(randomJokeText;
...
function showQuote() {
    ...
    const newElement = document.createElement('p');
    newElement.textContent = "Quote: '" + randomQuote.quote + "', Auther: '" + randomQuote.author + "'";
    src = document.querySelector('.content');
    src.appendChild(newElement);
...
function showRiddle() {
    ...
    flag = true;
    universel = randomRiddle;
    const breakLine = document.createElement('br');
    const newElement = document.createElement('p');
    newElement.textContent = "Question: '" + randomRiddle.question + "'";
    src = document.querySelector('.content');
    src.appendChild(newElement);
    src.appendChild(breakLine);
}
...
function revealAnswers() {
    ...
    if (!flag) {
        clearAll();
        const newElement = document.createElement('p');
        newElement.textContent = "Alert: no riddle in screen\n";
        src = document.querySelector('.content');
        src.appendChild(newElement);
    }
    else if (!condition) {
        ...
        const newElement = document.createElement('p');
        newElement.textContent = "Answer: '" + universel.answer + "'";
        src = document.querySelector('.content');
        src.appendChild(newElement);
        condition =false;
    }
